...
S_table E_base_venv(void)
{
	...
	*/
	...
	Tr_level out_level = Tr_outermost();
    S_table res = S_empty();
    S_enter(res, S_Symbol("print"), E_FunEntry(out_level, Temp_namedlabel("print"), Ty_TyList(Ty_String(), NULL), Ty_Void()));
    S_enter(res, S_Symbol("flush"), E_FunEntry(out_level, Temp_namedlabel("flush"), NULL, Ty_Void()));
    S_enter(res, S_Symbol("getchar"), E_FunEntry(out_level, Temp_namedlabel("getchar"), NULL, Ty_String()));
    S_enter(res, S_Symbol("ord"), E_FunEntry(out_level, Temp_namedlabel("ord"), Ty_TyList(Ty_String(), NULL), Ty_Int(0)));
    S_enter(res, S_Symbol("chr"), E_FunEntry(out_level, Temp_namedlabel("chr"), Ty_TyList(Ty_Int(0), NULL), Ty_String()));
    S_enter(res, S_Symbol("size"), E_FunEntry(out_level, Temp_namedlabel("size"), Ty_TyList(Ty_String(), NULL), Ty_Int(0)));
    S_enter(res, S_Symbol("substring"), E_FunEntry(out_level, Temp_namedlabel("substring"), Ty_TyList(Ty_String(), Ty_TyList(Ty_Int(0), Ty_TyList(Ty_Int(0), NULL))), Ty_String()));
    S_enter(res, S_Symbol("concat"), E_FunEntry(out_level, Temp_namedlabel("concat"), Ty_TyList(Ty_String(), Ty_TyList(Ty_String(), NULL)), Ty_String()));
    S_enter(res, S_Symbol("not"), E_FunEntry(out_level, Temp_namedlabel("not"), Ty_TyList(Ty_Int(0), NULL), Ty_Int(0)));
    S_enter(res, S_Symbol("exit"), E_FunEntry(out_level, Temp_namedlabel("exit"), Ty_TyList(Ty_Int(0), NULL), Ty_Void()));
    S_enter(res, S_Symbol("printi"), E_FunEntry(out_level, Temp_namedlabel("printi"), Ty_TyList(Ty_Int(0), NULL), Ty_Void()));
	return res;
